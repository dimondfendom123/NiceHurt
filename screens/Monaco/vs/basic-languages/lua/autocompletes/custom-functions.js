define(["require", "exports"], function (require, exports) {
	...
	exports.autocompletes = {
		"Function": {
			...
			"isIrisclosure()": {
				"insertText": "isIrisclosure(${1:f})",
				"documentation": {
					value: [
						"```lua", "function isIrisclosure(f: function)\n  -> boolean", "```",
						"",
						"Returns whether the closure was created by Iris."
					].join("\n")
				},
			},
			...
			"checkcaller()": {
				...
				"documentation": {
					value: [
						...
						"",
						"Returns whether the calling thread was created by Iris.",
					].join("\n")
				},
			},
			...
			"getcustomasset()": {
				...
				"documentation": {
					value: [
						...
						"",
						"Generates a rbxasset:// [`content`](https://developer.roblox.com/en-us/articles/Content) URL for the given asset from Iris's `workspace` directory.",
					].join("\n")
				},
			},
